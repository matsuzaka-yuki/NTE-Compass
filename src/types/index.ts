...
export function getIconUrl(type: MarkerType): string {
  return resolveAssetUrl(`./images/icons/${type}.webp`)
}
...
> = {
  phonebooth: {
    ...
    iconUrl: './images/icons/phonebooth.webp',
  },
  tower: {
    label: '维特海默塔',
    color: '#8b5cf6',
    ...
    iconUrl: './images/icons/tower.webp',
  },
  checkin: {
    label: '打卡点',
    color: '#22c55e',
    ...
    iconUrl: './images/icons/checkin.webp',
  },
  oraclestone: {
    label: '谕石',
    color: '#f59e0b',
    ...
    iconUrl: './images/icons/oraclestone.webp',
  },
  gift21: {
    label: '21的赠礼',
    color: '#ec4899',
    ...
    iconUrl: './images/icons/gift21.webp',
  },
  package: {
    label: '避役的包裹',
    color: '#14b8a6',
    ...
    iconUrl: './images/icons/package.webp',
  },
  anomaly: {
    label: '异象委托',
    color: '#ef4444',
    ...
    iconUrl: './images/icons/anomaly.webp',
  },
  sidequest: {
    label: '支线任务',
    color: '#f97316',
    ...
    iconUrl: './images/icons/sidequest.webp',
  },
  pilgrimage: {
    label: '圣地巡礼',
    color: '#6366f1',
    ...
    iconUrl: './images/icons/pilgrimage.webp',
  },
  qj: {
    label: '街景',
    color: '#06b6d4',
  ...
  sxyx: {
    ...
    iconUrl: './images/icons/sxyx.webp',
  },
  sqn: {
    label: '扫晴娘',
    color: '#fbbf24',
  ...
  yxxl: {
    ...
    iconUrl: './images/icons/yxxl.webp',
  },
  yxjy: {
    label: '异象界域',
    color: '#7c3aed',
    bgColor: '#ede9fe',
    icon: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z',
    iconUrl: './images/icons/yxjy.webp',
  },
  yxqd: {
    label: '异象追猎',
    color: '#dc2626',
    ...
    iconUrl: './images/icons/yxqd.webp',
  },
  mnzj: {
    label: '魔女之家',
    color: '#a855f7',
    bgColor: '#f3e8ff',
    icon: 'M12 2L4 7v2h2v11H4v2h16v-2h-2V9h2V7l-8-5zm-2 7h4v2h-4V9zm0 4h4v2h-4v-2zm0 4h4v2h-4v-2z',
    iconUrl: './images/icons/mnzj.webp',
  },
  fzyh: {
    label: '粉爪总行',
    color: '#fb7185',
    bgColor: '#ffe4e6',
    icon: 'M12 2L4 7v2h2v11H4v2h16v-2h-2V9h2V7l-8-5zm-2 7h4v2h-4V9zm0 4h4v2h-4v-2zm0 4h4v2h-4v-2z',
    iconUrl: './images/icons/fzyh.webp',
  },
  gmz: {
    label: '诡面筝',
    color: '#f43f5e',
  ...
  cpjfdl: {
    ...
    bgColor: '#cffafe',
    icon: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z',
    iconUrl: './images/icons/cpjfdl.webp',
  },
  nns: {
    label: '诺诺斯',
    color: '#84cc16',
  ...
  zyzd: {
    ...
    bgColor: '#f5d0fe',
    icon: 'M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z',
    iconUrl: './images/icons/zyzd.webp',
  },
  bbt: {
    label: '抱抱藤',
    color: '#22d3ee',
  ...
  fsjfdl: {
    ...
    iconUrl: './images/icons/fsjfdl.webp',
  },
  fjz: {
    label: '分解者',
    color: '#ef4444',
  ...
  wlcb: {
    ...
    bgColor: '#fae8ff',
    icon: 'M12 2L4 7v2h2v11H4v2h16v-2h-2V9h2V7l-8-5zm-2 7h4v2h-4V9zm0 4h4v2h-4v-2zm0 4h4v2h-4v-2z',
    iconUrl: './images/icons/wlcb.webp',
  },
  dht: {
    label: 'ReroRero电话亭',
    color: '#0ea5e9',
  ...
  htyf: {
    ...
    bgColor: '#f3fae3',
    icon: 'M12 2l4 6-4 6-4-6 4-6zm0 4.5L10.5 9 12 11.25 13.5 9 12 6.5z',
    iconUrl: './images/icons/htyf.webp',
  },
  yr: {
    label: '雨人',
    color: '#64748b',
