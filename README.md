...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/开源-AGPL--3.0-red?style=flat-square&logo=gnu" />
...
7. **开放许可**：本项目基于 **AGPL-3.0** 协议开源，详见 [LICENSE](LICENSE) 文件。作为网络服务部署时，必须向所有用户公开完整源码。标记点数据随项目一同开放，欢迎贡献。但请不要直接用于商业用途，谢谢喵
...
本项目基于 [Horizony14/map_NTE](https://github.com/Horizony14/map_NTE)（MIT 协议）开发，感谢原作者的贡献。MIT 协议允许将其代码并入更强 copyleft 的项目，故本仓库整体采用 AGPL-3.0。原 MIT 协议的版权声明与许可证全文保留在 [LICENSE.MIT](LICENSE.MIT)。

部分点位数据源自 [MaaNTE-Map](https://github.com/MaaNTE/MaaNTE-Map)（AGPL-3.0），按其许可证要求，本项目一并采用 AGPL-3.0 开源。
